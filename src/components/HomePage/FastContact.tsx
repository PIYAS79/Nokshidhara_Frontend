...
const FastContact = () => {
    return (
        <div className='text-[1rem] md:text-[2rem] content_container mx-auto my-5 md:my-10 px-2 md:px-0'>
            <div className='flex justify-center'>
                <button className='rounded-xl deepPurple text-white text-[1rem] md:text-[2rem] w-[456px] py-2 md:py-3 font-extrabold'>
